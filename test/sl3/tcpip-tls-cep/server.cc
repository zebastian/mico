...
main (int argc, char *argv[])
{
	...
	MICOSL3Utils::PP::print_own_credentials(&wcout, c2);
        ...
        SL3TCPIP::TCPIPArgBuilder_var builder2
            ...
            (fact2->create_arg_builder(SL3CM::CU_AcceptOnly));
        assert(!CORBA::is_nil(builder2));
        builder2->add_tcpip_acceptor_options(sseq, "localhost", 3333, 0, 0, FALSE);
        SL3AQArgs::Argument_var arg2 = builder2->reap_args();
