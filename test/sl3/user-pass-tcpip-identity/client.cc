...
main (int argc, char *argv[])
{
    ...
    SL3PM::PrincipalName qp_name;
    qp_name.the_type = (const char*)SL3PM::NT_StringName;
    qp_name.the_name.length(1);
    qp_name.the_name[0] = L"karel_identity";
    csi_builder->add_named_quoted_principal(qp_name);
