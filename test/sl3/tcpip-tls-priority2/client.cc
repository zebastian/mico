...
main (int argc, char *argv[])
{
  ...
  builder->add_tcpip_initiator_options("localhost", 8789, 8799, 0);
  ...
  builder2->add_tcpip_initiator_options("localhost", 15345, 15354, 0);
  ...
  TransportSecurity::OwnCredentials_ptr creds2 = acquirer2->get_credentials(TRUE);
